...
// =============================================================================
// FICHIER : database/migrations/2024_01_01_000012_create_ligne_budget_mensuels_table.php
// =============================================================================
return new class extends Migration {
    public function up(): void
    {
        Schema::create('ligne_budget_mensuel', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['id_exercice', 'rub_rubrique_id', 'mois']);
            $table->index(['id_exercice', 'mois']);
        });
    }
    public function down(): void { Schema::dropIfExists('ligne_budget_mensuel'); }
};
