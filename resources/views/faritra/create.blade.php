...
{{-- ============================================================ --}}
{{-- FICHIER : resources/views/faritra/create.blade.php --}}
{{-- ============================================================ --}}
@extends('layouts.app')
@section('title', 'Nouveau Faritra')
@section('content')
<div class="container-fluid py-4">
    <div class="d-flex align-items-center gap-3 mb-4">
        <a href="{{ route('faritraS.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i></a>
        <h1 class="h4 mb-0">Nouveau Faritra</h1>
    </div>

    <form action="{{ route('faritraS.store') }}" method="POST">
        @csrf
        <div class="card shadow-sm">
            <div class="card-body row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold required">Libellé</label>
                    <input type="text" name="libelle_faritra" value="{{ old('libelle_faritra') }}"
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="sigle" value="{{ old('sigle') }}" class="form-control">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Ordre</label>
                    <input type="number" name="num_ordre_faritra" value="{{ old('num_ordre_faritra') }}" class="form-control">
                </div>
                <div class="col-md-6">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            <a href="{{ route('faritraS.index') }}" class="btn btn-outline-secondary">Annuler</a>
